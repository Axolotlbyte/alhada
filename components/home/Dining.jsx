...
const Dining = () => {
  return (
    ...
    <section className="w-full flex flex-col gap-16 justify-center items-center py-8">
      ...
      >
        {/* Big square */}
        <div className="bg-red-500 h-full rounded-lg flex items-center justify-center">
          <span className="text-white text-2xl font-bold">Big Square</span>
        </div>
        ...
        <div className="grid grid-rows-3 gap-6 h-full">
          <div className="bg-blue-500 rounded-lg flex items-center justify-center">
            <span className="text-white font-bold">Small 1</span>
          </div>
